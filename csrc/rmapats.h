...
void  hs_0_M_14_5__salida_daidir (UB  * pcode, UB  val);
void  hs_0_M_15_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_15_5__salida_daidir (UB  * pcode, UB  val);
...
void  hs_0_M_45_11__salida_daidir (UB  * pcode, scalar  val);
...
void  hs_0_M_69_21__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_69_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_69_1__salida_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_69_2__salida_daidir (UB  * pcode);
void  hs_0_M_69_9__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_69_11__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_70_21__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_70_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_70_1__salida_daidir (UB  * pcode, scalar  val, U  I699, scalar  * I1368, U  did);
void  hs_0_M_70_2__salida_daidir (UB  * pcode);
void  hs_0_M_70_11__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_71_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_72_0__salida_daidir (UB  * pcode, scalar  val);
void  hs_0_M_72_9__salida_daidir (UB  * pcode, scalar  val);
